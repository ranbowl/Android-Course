 ...
 */
public class map_dialog extends AppCompatActivity implements
        OnMapReadyCallback,
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener, GoogleMap.OnMapLongClickListener {

    private static final String TAG = map_dialog.class.getSimpleName();
    ...
    private double resultLng, resultLat;
    ...
    public void onMapLongClick(LatLng point) {
        ...
        TextView showAddress = (TextView) findViewById(R.id.txt_address);
        ...
        resultLat = point.latitude;
        resultLng = point.longitude;
    ...
    public void onClick(View v) {
        ...
        intent.putExtra("longitude", resultLng);
        intent.putExtra("latitude", resultLat);
